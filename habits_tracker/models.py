...
class Habit(models.Model):
    ...
    periodicity = models.PositiveIntegerField(
        choices=PERIODICITY_CHOICES, default=1, verbose_name="Периодичность выполнения привычки (в днях)"
    )
    ...
    time_to_complete = models.PositiveIntegerField(
        verbose_name="Время на выполнение (в секундах)", default=120, help_text="Должно быть не более 120 секунд"
    )
